    ...
    <div className="min-h-screen relative bg-[#F5F5F5] pb-32 overflow-x-hidden selection:bg-[#D75437] selection:text-white">
      ...
      <div className="fixed bottom-10 left-0 w-full flex flex-col items-center gap-6 z-[900] pointer-events-none px-6">
        <div className="w-full max-w-[500px] flex justify-end gap-4">
           <button onClick={() => navigateToView('image-lab')} className="pointer-events-auto p-5 bg-[#1C39BB] text-white rounded-full shadow-2xl hover:scale-110 transition-all group backdrop-blur-md border border-white/20" title="实验室">
             <FlaskConical size={24} className="group-hover:rotate-12 transition-transform" />
           </button>
           <button onClick={() => window.open(ASSETS.xhs_link, '_blank')} className="pointer-events-auto p-5 bg-[#D75437] text-white rounded-full shadow-2xl hover:scale-110 transition-all group backdrop-blur-md border border-white/20" title="小红书">
             <Share2 size={24} className="group-hover:rotate-12 transition-transform" />
           </button>
        </div>
        <div className="pointer-events-auto w-full max-w-[520px]">
          <div className="flex items-center justify-around glass-dark px-6 py-5 rounded-full border border-white/10 shadow-2xl backdrop-blur-3xl bg-black/90">
            {[
